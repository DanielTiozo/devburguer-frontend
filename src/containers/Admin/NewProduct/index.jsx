...
import { SubmitButton, Container, Form, InputGroup, Label, Input, LabelUpload, Select, ErrorMessage, ContainerCheckBox } from './styles'
...
const schema = yup
	.object({
		...
		}).test('fileSize', 'Escolha arquivos com até 5Mb', value => {
			return value && value.length > 0 && value[0].size <= 500000;
		}).test('type', 'Somente imagem png ou jpeg', value => {
...
export function NewProduct() {
	...
	const onSubmit = async (data) => {
		...
		await toast.promise(api.post('/products', productFormData), {
			...
			error: 'Erro ao adiconar o produto, tente novamente'
		})
